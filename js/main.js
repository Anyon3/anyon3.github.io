...
$('.grsecurity').on('click', function() {
	...
	$('<p>26 May 2017 was a disaster for the free and public access to one the best (if it\'s not, the best) security stuff. Special thanks to intel and other big corporate for have made this shit happen.</p>').appendTo('#mblock');
	$('<p><a href="https://grsecurity.net" title="grsecurity linux">Grsecurity official website</a></p>').appendTo('#mblock');
});

$('.startx').off('click');
$('.startx').on('click', function() {
	$('#mblock').empty();
